...
namespace backend.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CollectionPointCollectors",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollectionPointCollectors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CollectionPointCollectors_CollectionPoints_CollectionPointId",
                        column: x => x.CollectionPointId,
                        principalTable: "CollectionPoints",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CollectionPointCollectors_Collectors_CollectorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionPointCollectors_CollectionPointId",
                table: "CollectionPointCollectors",
                column: "CollectionPointId");

            migrationBuilder.CreateIndex(
                name: "IX_CollectionPointCollectors_CollectorId",
                table: "CollectionPointCollectors",
                column: "CollectorId");
